...
### Fixed
- **API**: Resolved 307 redirect issues by correcting URL construction in `HttpClient`
- **Schedule**: Updated `ScheduleClient` to use correct web API base URL
- **Game**: Fixed `GameClient` shift chart endpoint path
