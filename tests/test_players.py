...
class TestPlayersMethod:
    ...
    def test_players_active_only_default(self):
        ...
        for player in players:
            ...
            assert player._data.get('is_active') is True, f"Player {player} should be active"
    ...
    def test_players_all_players(self):
        ...
        assert len(all_players) >= len(active_players), "All players should be >= active players"
        ...
        inactive_count = sum(1 for p in all_players if p._data.get('is_active') is False)
    ...
    def test_player_object_structure(self):
        ...
        for player in test_players:
            ...
            assert data['position'] in ['C', 'L', 'R', 'D', 'G'], f"Position {data['position']} should be valid"
    ...
    def test_player_string_methods(self):
        ...
        assert player._data['first_name'] in full_name, "full_name should contain first name"
        assert player._data['last_name'] in full_name, "full_name should contain last name"
    ...
    def test_players_return_count_reasonable(self):
        ...
        assert 1500 <= len(active_players) <= 3000, (
    ...
    def test_players_contain_known_positions(self):
        ...
        expected_positions = {'C', 'L', 'R', 'D', 'G'}  # Center, Left Wing, Right Wing, Defense, Goalie
...
class TestPlayersIntegration:
    ...
    def test_players_data_consistency(self):
        ...
        assert len(players1) == len(players2), "Multiple calls should return same number of players"
